...
public interface GroupMapper {
	...
	@Insert(" insert into `group` (cooperate_id,cooperate_name,group_name,group_v,group_a,group_ah,indi_m,indi_n,dod,middle_v,surplus_time,group_total_time) values (#{cooperate_id},#{cooperate_name},#{group_name},#{group_v},#{group_a},#{group_ah},#{indi_m},#{indi_n},#{dod},#{middle_v},#{surplus_time},#{group_total_time}) ")
