		...
		<form action="pow/dangerInfos" method="post" style="margin-top: 130px;text-align: center;">
			...
			<table class="table table-bordered" >
				<tr >
				  ...
				  <td class="danger" style="font-size: 20px;"></td> 
				</tr>
				<tr>
					  ...
					  <c:if test="${page.list[0].powertemplower==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">温度过低</td>
					  </c:if>
					  <c:if test="${page.list[0].powertemphigher==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">温度过高</td>
					  </c:if>
					  <c:if test="${page.list[0].indivhighers==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">单体电池过压</td>
					  </c:if>
					  <c:if test="${page.list[0].indivlowers==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">单体电池欠压</td>
					  </c:if>
					  <c:if test="${page.list[0].groupvhigher==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">电池过压</td>
					  </c:if>
					  <c:if test="${page.list[0].groupvlower==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">电池欠压</td>
					  </c:if>
					  <c:if test="${page.list[0].powerahigher==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">电池过流</td>
					  </c:if>
					  <c:if test="${page.list[0].bmu==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">BMU通讯故障</td> 
					  </c:if>
				</tr>
				<tr>
					...
					<c:if test="${page.list[1].lipower==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">锂电电池失效</td>
					  </c:if>
					  <c:if test="${page.list[1].templower==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">电池温度过低</td>
					  </c:if>
					  <c:if test="${page.list[1].temphigher==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">电池温度过高</td>
					  </c:if>
					  <c:if test="${page.list[1].indivhigher==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">单体电池过压</td>
					  </c:if>
					  <c:if test="${page.list[1].indivlower==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">单体电池欠压</td>
					  </c:if>
					  <c:if test="${page.list[1].powervhigher==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">电池过压</td>
					  </c:if>
					  <c:if test="${page.list[1].powervlower==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">电池欠压</td> 
					  </c:if>
				</tr>
				<tr>
					<td class="" style="line-height:35px;font-size: 17px; ">${page.list[2].ip }</td> 
					<td class="" style="line-height:35px;font-size: 17px; ">${page.list[2].warntime }</td>
					<td class="" style="line-height:35px ;font-size: 17px;">${page.list[2].group_name }</td>
					<c:if test="${page.list[2].power==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">电池故障</td>
					  </c:if>
					  <c:if test="${page.list[2].ahlower==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">剩余容量过低故障</td>
					  </c:if>
					  <c:if test="${page.list[2].outpower==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">放电支路故障</td>
					  </c:if>
					  <c:if test="${page.list[2].inpower==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">充电支路故障</td>
					  </c:if>
					  <c:if test="${page.list[2].middlev==1}">
