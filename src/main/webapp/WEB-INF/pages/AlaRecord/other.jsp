	...
	<div style="width: 70%;margin: 0 auto;">
		<form action="pow/dangerInfos" method="post" style="margin-top: 130px;text-align: center;">
			...
			<table class="table table-bordered" >
				...
				<tr>
					  <td class="" style="line-height:35px;font-size: 17px; ">${other.ip }</td> 
					  <td class="" style="line-height:35px;font-size: 17px; ">${other.warntime }</td>
					  <td class="" style="line-height:35px ;font-size: 17px;">${other.group_name }</td>
					  <c:if test="${other.power==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">电池故障</td>
					  </c:if>
					  <c:if test="${other.ahlower==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">剩余容量过低故障</td>
					  </c:if>
					  <c:if test="${other.outpower==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">放电支路故障</td>
					  </c:if>
					  <c:if test="${other.inpower==1}">
					  	<td class="" style="line-height:35px ;font-size: 17px;">充电支路故障</td>
					  </c:if>
					  <c:if test="${other.middlev==1}">
